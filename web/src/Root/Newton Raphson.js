...
class newtonraphson extends React.Component {
  ...
  componentDidMount() {
    axios.get("http://192.168.99.100:9000/api/getnewtonraphson").then(res => {
  ...
  newtonraphson(x) {
      ...
      do {
          xm = x;
          x = xm - (this.func(xm) / this.funcd(xm));
          console.log(x);
    ...
    return (
      <Layout>
          ...
          <div onChange={this.handleChange}>
            ...
            <Button onClick={() => this.newtonraphson(this.state.x)} size="large" type="primary">SUMMIT  </Button><br></br><br></br>
