...
class Falseposition extends React.Component {
  ...
  componentDidMount() {
    axios.get("http://192.168.99.100:9000/api/getfalseposition").then(res => {
  ...
  Falseposition(xl, xr) {
    ...
    do {
      ...
      console.log("Xl", data['xl'][i])
      console.log("Xr", data['xr'][i])
      console.log("Xm", data['x'][i])
      console.log("Error", data['error'][i])
      i++;
    ...
    return (
      <Layout>
        ...
        <div onChange={this.handleChange}>
          ...
          <Button onClick={() => this.Falseposition(parseFloat(this.state.xl), parseFloat(this.state.xr))} size="large" type="primary">SUMMIT  </Button><br></br><br></br>
